...
<script type="text/javascript">
	...
	<form  action="${pageContext.request.contextPath}/emp/login" ,method="GET" >
	<DIV>
											...
											<TBODY>
												<TR>
													...
													<TD><INPUT class=regtxt title=请填写用户名 maxLength=16
														size=16 name=username id=username value="zsf123"></TD>
												</TR>
												<TR>
													<TD align=middle width=81><FONT color=#ffffff>密&nbsp;
															码：</FONT></TD>
													<TD><INPUT class=regtxt title=请填写密码 type=password
														maxLength=16 size=16 name=password id=pass value="000000"></TD>
												</TR>
												<TR>
													<TD align=middle width=81><FONT color=#ffffff>验证码：</FONT></TD>
													<TD><INPUT style="width: 75px" class=regtxt title=请填写验证码 maxLength=50
														  name="code">
													<img id="image" src="${pageContext.request.contextPath}/code/getCode?time="<%=new Date()%> />
												</TR>
											</TBODY>
										</TABLE>
									</TD>
