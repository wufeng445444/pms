...
<link rel="stylesheet" type="text/css" href="skin/css/base.css">
	...
	<script type="application/javascript">
		$(function () {
			$.ajax({
				type:"GET",
				url:"${pageContext.request.contextPath}/pro/withAnalyseJsonList",
				success:function(msg){
				    $(msg).each(function (index.item) {
						$("#projects").append("<option value='"+item.pid+"'>"+item.pname+"</option>")
                    });
				}
			});
        });
		...
		function parseAnalysis(pid) {
            $.ajax({
                type:"GET",
                url:"${pageContext.request.contextPath}/analysis/info/"+pid,
                success:function(msg){
            ...
            $.ajax({
                type:"GET",
                url:"${pageContext.request.contextPath}/module/list/"+pid,
                success:function(msg){
...
<tr >
	...
	<td  align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
		<select id="projects" onchange="parseAnalysis(this.value)">
		...
		-<select onchange="parseFunction(this.value)">
		<option value=1>请选择</option>
